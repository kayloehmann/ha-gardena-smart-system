...
_PATCH_AM_CLIENT = "custom_components.gardena_smart_system_ng.automower_coordinator.AutomowerClient"
_PATCH_AM_AUTH = "custom_components.gardena_smart_system_ng.automower_coordinator.GardenaAuth"
_PATCH_AM_WS = "custom_components.gardena_smart_system_ng.automower_coordinator.AutomowerWebSocket"
...
class TestAutomowerCalendar:
    ...
    async def test_async_get_events_generates_events_from_tasks(
        ...
        async with _setup_automower(hass, automower_config_entry, devices):
            ...
            from custom_components.gardena_smart_system_ng.automower_calendar import (
...
class TestAutomowerCoordinator:
    ...
    async def test_command_throttle_raises_when_burst_exhausted(
        ...
        from custom_components.gardena_smart_system_ng.const import COMMAND_BURST_CAPACITY
...
class TestAutomowerDiagnostics:
    ...
    async def test_automower_diagnostics(
        ...
        from custom_components.gardena_smart_system_ng.diagnostics import (
...
class TestAutomowerRoutingGuards:
    ...
    @pytest.mark.parametrize(
        "module_path",
        [
            "custom_components.gardena_smart_system_ng.automower_sensor",
            "custom_components.gardena_smart_system_ng.automower_binary_sensor",
            "custom_components.gardena_smart_system_ng.automower_switch",
            "custom_components.gardena_smart_system_ng.automower_device_tracker",
            "custom_components.gardena_smart_system_ng.automower_number",
            "custom_components.gardena_smart_system_ng.automower_calendar",
            "custom_components.gardena_smart_system_ng.automower_lawn_mower",
            "custom_components.gardena_smart_system_ng.automower_event",
            "custom_components.gardena_smart_system_ng.automower_button",
        ],
    )
    async def test_routing_guard_returns_early_for_gardena_entry(
        ...
        _P_CLIENT = "custom_components.gardena_smart_system_ng.coordinator.GardenaClient"
        _P_AUTH = "custom_components.gardena_smart_system_ng.coordinator.GardenaAuth"
        _P_WS = "custom_components.gardena_smart_system_ng.coordinator.GardenaWebSocket"
...
class TestAutomowerEntityNoneGuards:
    ...
    async def test_binary_sensor_is_on_none_when_device_gone(
        ...
        from custom_components.gardena_smart_system_ng.automower_binary_sensor import (
    ...
    async def test_sensor_native_value_none_when_device_gone(
        ...
        from custom_components.gardena_smart_system_ng.automower_sensor import (
            SENSOR_DESCRIPTIONS,
    ...
    async def test_device_tracker_latitude_none_when_device_gone(
        ...
        from custom_components.gardena_smart_system_ng.automower_device_tracker import (
