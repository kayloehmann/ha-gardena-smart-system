    ...
    async def test_mower_event_entity_created(
        ...
        try:
            ...
            entries = [
                ...
                if e.platform == "gardena_smart_system_ng" and e.domain == "event"
            ]
    ...
    async def test_mower_event_not_created_without_mower(
        ...
        try:
            ...
            entries = [
                e
                for e in entity_reg.entities.values()
                if e.platform == "gardena_smart_system_ng"
                and e.domain == "event"
...
class TestValveEventSingleValvePlaceholder:
    ...
    async def test_single_valve_event_has_empty_zone_placeholder(
        ...
        from custom_components.gardena_smart_system_ng.gardena_event import (
