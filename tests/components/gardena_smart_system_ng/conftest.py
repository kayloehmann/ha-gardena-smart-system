...
def _shrink_command_timeout_poll_window():
    ...
    with (
        patch(
            "custom_components.gardena_smart_system_ng.entity.COMMAND_POLL_AFTER_TIMEOUT_SECONDS",
            0.0,
        ),
        patch(
            "custom_components.gardena_smart_system_ng.entity.COMMAND_POLL_INTERVAL_SECONDS",
            0.0,
        ),
        patch(
            "custom_components.gardena_smart_system_ng.automower_entity"
            ".COMMAND_POLL_AFTER_TIMEOUT_SECONDS",
            0.0,
        ),
        patch(
            "custom_components.gardena_smart_system_ng.automower_entity.COMMAND_POLL_INTERVAL_SECONDS",
            0.0,
        ),
    ):
        yield
